...
public class FlowCapturer{
	...
	class HadoopPacketPrinter implements PacketReceiver {	
		...
		public void receivePacket(Packet packet) {    			
			...
			*/
				fw.write(Long.toString(packet.sec));
				fw.write(Long.toString(packet.usec));
				fw.write(Long.toString(packet.caplen));
				fw.write(Long.toString(packet.len));
	...
	void setFlowFilter(String exportIp, String dstPort) throws Exception{
		String filter = null;
...
//		conf.addResource("hdfs-site.xml");
	...
	public FlowCapturer(String deviceName) throws Exception{	
	...
	public FlowCapturer(String deviceName, String dstPath, int interval, String dstPort) throws Exception{	
	 ...
	 * @throws Exception 
	 */
	public FlowCapturer(String exportIp, String dstPort, String deviceName, String dstPath, int interval) throws Exception{
